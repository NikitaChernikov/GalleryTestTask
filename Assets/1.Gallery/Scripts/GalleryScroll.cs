...
public class GalleryScroll : MonoBehaviour
{
    ...
    {
        // ќпределить высоту строки на основе префаба изображени€
        ...
        // ѕостепенно загружать изображени€ с сервера, пока не будет ошибка загрузки
        while (true)
        {
            ...
            {
                Debug.Log("ќшибка загрузки изображени€: " + request.error);
                break;
            }
        }
